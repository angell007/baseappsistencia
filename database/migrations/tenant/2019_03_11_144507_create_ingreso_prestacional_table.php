...
class CreateIngresoPrestacionalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ingreso_prestacional', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ingreso_prestacional');
    }
}
