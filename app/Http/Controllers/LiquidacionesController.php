...
class LiquidacionesController extends Controller
{
    ...
    /**
     * Retornar objeto JSON con cálculo de liquidación modificando los días acumulados de vacaciones del funcionario,esta acción es realizada por el usuario
     *
     * @param int $id
     * @param string $fechaFin
    ...
    public function getWithVacacionesActuales($id)
    {
        ...
        return NominaLiquidacion::liquidacionFuncionarioWithId($id)->until($fechaFin)->withVacacionesActuales($diasAcumulados)->calculate()->makeResponse();
    }
    ...
    public function getPdfLiquidacion()
    {
        $funcionario = null;
        $nombrePdf = null;
        $empresa = Empresa::first()['razon_social'];
