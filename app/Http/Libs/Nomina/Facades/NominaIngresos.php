...
class NominaIngresos extends PeriodoPago
{
    ...
    public function fromTo($fechaInicio, $fechaFin)
    {
        ...
        $this->calculoIngresos = new CalculoIngresos(
            IngresoPrestacional::obtener(self::$funcionario, $this->fechaInicio, $this->fechaFin)->concat(IngresoNoPrestacional::obtener(self::$funcionario, $this->fechaInicio, $this->fechaFin))
        );
